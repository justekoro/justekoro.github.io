window.onload = () => {
    ...
    $("#wai-t").click(()=>{
        ...
        setTimeout(()=>{
            ...
            $("#text").html("hi! I'm koro, a 19 yo developer from France.<br/>I started programming in 2017 with Discord Bots, applications that allows you to use almost the full potential of Discord by coding. Then, I wanted to try other things and I got interested in web development in 2019. I only have the basics in frontend development.");
